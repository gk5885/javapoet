...
import static com.squareup.javawriter.JavaIdentifiers.isValidJavaIdentifier;
 ...
 * @since 2.0
 */
final class ClassName implements Comparable<ClassName> {
  ...
  ImmutableList<String> enclosingSimpleNames() {
    return enclosingSimpleNames;
  }

  Optional<ClassName> enclosingClassName() {
  ...
  ClassName nestedClassNamed(String memberClassName) {
